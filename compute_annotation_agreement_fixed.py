"""
compute_annotation_agreement_fixed.py
-------------------------------------
...
Main fixes compared with the previous script:
  ...
  3. Saves a clearer results workbook.
"""
...
def token_overlap(a, b):
    return SequenceMatcher(None, str(a).lower().split(), str(b).lower().split()).ratio()
...
def save_results(kappa, n_pairs, auto_metrics, df_a, df_b, matched_df, out_dir):
    ...
    out_path = out_dir / "annotation_agreement_results.xlsx"
